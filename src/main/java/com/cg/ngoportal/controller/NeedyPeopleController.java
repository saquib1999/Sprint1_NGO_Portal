...
public class NeedyPeopleController {
	...
	public ResponseEntity<String> loginNeedyPerson(@RequestBody Login login) throws NoSuchNeedyPersonException {
		return new ResponseEntity<String>(needyPeopleService.loginNeedyPerson(login.getUsername(), login.getPassword()),
				HttpStatus.ACCEPTED);
	}
	...
	@PatchMapping("/modify-details")
	public ResponseEntity<NeedyPeople> updateNeedyPerson(@RequestBody NeedyPeople needyPerson) throws NoSuchNeedyPersonException, UserNotLoggedInException{
