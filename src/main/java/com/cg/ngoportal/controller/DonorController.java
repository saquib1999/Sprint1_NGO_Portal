...
public class DonorController {
	...
	@PostMapping("/donate")
	public ResponseEntity<Donation> donateToNGO(@RequestBody Donation donation) throws UserNotLoggedInException {	
	...
	public ResponseEntity<String> sendThankyouMailToDonator() throws UserNotLoggedInException {	
	...
	public ResponseEntity<String> emailPasswordToDonor() throws UserNotLoggedInException {	
